        ...
        return(
            <div className="parent-div">
                <div className="vert-align">                    
                    ...
                    <input type="text" placeholder="First Name" onChange={() => updateFirst(this.target.value)}/>
                    <input type="text" placeholder="Last Name" onChange= {() => updateLast(this.target.value)}/>
                    <input type="text" placeholder="email" onChange={() => updateEmail(this.target.value)}/>
